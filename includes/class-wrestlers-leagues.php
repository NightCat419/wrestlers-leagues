...
class Wrestlers_Leagues {
	...
	public function __construct ( $file = '', $version = '1.0.0' ) {
		...
		if ( is_admin() ) {
			$this->admin = new wrestlers-leagues_Admin_API();
		}
	...
	public function register_post_type ( $post_type = '', $plural = '', $single = '', $description = '', $options = array() ) {
		...
		$post_type = new wrestlers-leagues_Post_Type( $post_type, $plural, $single, $description, $options );
	...
	public function register_taxonomy ( $taxonomy = '', $plural = '', $single = '', $post_types = array(), $taxonomy_args = array() ) {
		...
		$taxonomy = new wrestlers-leagues_Taxonomy( $taxonomy, $plural, $single, $post_types, $taxonomy_args );
